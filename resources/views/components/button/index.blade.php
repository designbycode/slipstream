...
@php
    ...
    $ghostColors = [
        'primary' => 'text-primary-600 hover:bg-primary-50 focus:ring-primary-200 disabled:opacity-75',
        'secondary' => 'text-gray-600 hover:bg-gray-50 focus:ring-gray-200 disabled:opacity-75',
        'danger' => 'text-red-600 hover:bg-red-50 focus:ring-red-200 disabled:opacity-75',
        'info' => 'text-blue-600 hover:bg-blue-50 focus:ring-blue-200 disabled:opacity-75',
        'warning' => 'text-yellow-600 hover:bg-yellow-50 focus:ring-yellow-200 disabled:opacity-75',
    ];
