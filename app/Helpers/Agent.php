<?php
    ...
    class Agent extends MobileDetect
    {
        ...
        {
            return $this->retrieveUsingCacheOrResolve('slipstream.platform', function () {
        ...
        {
            return $this->retrieveUsingCacheOrResolve('slipstream.browser', function () {
                return $this->findDetectionRulesAgainstUserAgent(
        ...
        {
            return $this->retrieveUsingCacheOrResolve('slipstream.desktop', function () {
